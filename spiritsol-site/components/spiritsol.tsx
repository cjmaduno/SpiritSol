...
import logo from "../public/altercall.png";

const SpiritSol: React.FC = () => {
  const CHARACTER_LIMIT: number = 32;
  const ENDPOINT: string =
    "https://6s6pl59wci.execute-api.us-west-1.amazonaws.com/prod/generate_solution_and_charities";
      ...
      <div className="max-w-md m-auto p-2">
        <div className="bg-slate-800 p-6 rounded-md text-white">
          <div className="text-center my-6">
            ...
            <div className={gradientTextStyle}>Your AI spiritual entrepeneurship assistant</div>
          </div>
